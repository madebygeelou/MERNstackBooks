...
const CreateBooks = () => {
    ...
    return (react_1.default.createElement("div", { className: 'p-4' },
        ...
        react_1.default.createElement("h1", { className: 'text-3xl my-4' }, "Create Book"),
        ...
        react_1.default.createElement("div", { className: 'flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto' },
            ...
            react_1.default.createElement("button", { className: 'p-2 bg-sky-300 m-8', onClick: handleSaveBook }, "Save"))));
};
